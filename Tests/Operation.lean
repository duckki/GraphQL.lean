...
theorem fieldsWithMissingResponseNameSmoke :
    SelectionSet.fieldsWithResponseName "name"
      sampleHeroQuery.selectionSet = [] := by
  rfl

theorem fieldsWithAliasResponseNameSmoke :
    SelectionSet.fieldsWithResponseName "mainHero"
      sampleHeroQuery.selectionSet = sampleHeroQuery.selectionSet := by
  rfl
...
theorem operationSizeSmoke :
    sampleHeroQuery.size =
      SelectionSet.size sampleHeroQuery.selectionSet := by
  rfl
